...
export class BlogService {
  ...
  public async getAllArticles(params: any): Promise<Record<string, any>> {
    ...
    const sql = `SELECT  p1.id, p1.post_excerpt, p1.post_date,p1.post_title,p1.post_content,p1.post_name,p1.post_modified,wm2.meta_value, u.user_nicename, u.display_name,u.user_email, t.name as terms_name,(SELECT group_concat(wp_terms.name separator ', ') FROM wp_terms
